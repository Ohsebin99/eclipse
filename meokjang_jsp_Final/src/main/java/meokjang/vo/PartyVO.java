...
public class PartyVO {
	...
	public PartyVO(String iD, String nickName, String category, String location, String subject, String content,
			String place, String partyGender, Date mealDate, Date limitDate, String photo, String acholchk, String ip,
			int minLimitAge, int maxLimitAge, int limitNum) {
		super();
		ID = iD;
