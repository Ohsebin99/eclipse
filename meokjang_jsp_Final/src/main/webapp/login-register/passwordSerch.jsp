...
<!-- private -->
<script type="text/javascript" src="../js/passwordSerch.js"></script>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
				<form class="comment-form mb-3 gray-bg p-5" action="passwordSerchOK.jsp" method="post" onsubmit="return passwordSerch()">
					<h1 class="mb-4" style="vertical-align: middle; text-align: center; font-size: 25px;">비밀번호 찾기</h1>
					<div class="row">
						<div class="col-lg-12">
							<input type="text" placeholder="아이디" name="ID" class="form-control mb-3"/><br/>
