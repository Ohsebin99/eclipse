...
<!-- private -->
<script type="text/javascript" src="../js/myProfileChk.js"></script>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
				<form id="myProfile" class="comment-form mb-3 gray-bg p-5" action="myProfile.jsp" method="post" onsubmit="return passwordCheck()">
					...
					<div class="d-grid">
						<input class="btn btn-primary btn-block mb-3" type="submit" value="내 정보 수정"/>
					</div>
				</form>
			</div>
		</div>
