...
<!--
 ...
 <label>나이: <input type="text" name ="age"><br> </label>
  ...
  <!-- 
 	 ...
 	 넘겨줄 데이터를 value 속성을 사용해서 넣어줘야 한다.
 ...
 <label> <input type="radio" name="gender" value ="여자">여자</label>
  ...
  <legend>취미</legend>
  <label> <input type="checkbox" name="hobbies" value="등산">등산</label>
  <label> <input type="checkbox" name="hobbies" value="바둑">바둑</label>
  <label> <input type="checkbox" name="hobbies" value="낚시">낚시</label>
  </fieldset><br>
  ...
  <!-- 
  		...
  		목록상자에 표시되는 아이템의 개수는 4개가 기본값으로 표시되고 size 속성을 
  		지정하면 지정한 만큼 표시된다.
   -->
   ...
   <select name ="travel" style="width: 200px;" multiple="multiple" size="7">
  	...
  	<!-- 
  	<textarea> 태그에는 value 속성이 없다. <textarea> ~</textarea> 사이클 value로 취급한다.
  	...
  	<input type="button" value="그냥버튼" onclick="alert('dddddddddddddddddddd')">
  	<button type="submit">정보보기</button>
  	<button type="reset">다시쓰기</button>
  	<button type="button" onclick="alert('dddddddddddddddddddd')">그냥 버튼</button>
