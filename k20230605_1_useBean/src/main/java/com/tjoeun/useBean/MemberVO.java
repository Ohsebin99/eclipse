...
//	필드 선언
//	VO 클래스의 필드 이름은 VO 클래스에 저장될 데이터가 입력되는 form을 구성하는 요소들의 name 속성에
//	지정한 속성값과 데이터베이스 테이블을 구성하는 필드 이름과 반드시 같은 이름으로 만들어야 한다.
	private String id;
	private String name;
...
public String toString() {
	return "MemberVO [id=" + id + ", name=" + name + ", password=" + password + ", age=" + age + ", gender=" + gender
			+ ", ip=" + ip + "]";
}
