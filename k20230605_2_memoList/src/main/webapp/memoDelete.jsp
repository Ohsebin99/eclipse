...
<%				
				...
				// 삭제할 글이 테이블에 존재하지 않기 때문에 에러 메시지를 출력하고 memoList4.jsp로
				// 돌려보낸다.
				out.println("<script>");
			...
			//	삭제할 글번호 또는 돌아갈 페이지 번호가 숫자가 아니므로 에러 메시지를 출력하고
		...
		// 삭제할 글번호 또는 돌아갈 페이지 번호가 넘어오지 않았으므로 에러 메시지를 출력하고
		// memoList4.jsp로 돌려보낸다.
		out.println("<script>");
