...
<!-- 
	수정 또는 삭제할 글 1건을 얻어와서 request 영역에 저장한 후 수정 또는 삭제할 글을 브라우저에 표시하는
	페이지(delete.jsp, update.jsp)로 넘겨준다.
-->
...
//	out.println(vo);
	...
	//	out.println("location.href='list.jsp?cuurentPage=" + currentPage + "'");
		out.println("</script>");
